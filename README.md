# Gamma: End-to-End Telco Churn Prediction Pipeline [![ci](https://github.com/PabloFerrerGonzalez333/gamma/actions/workflows/ci.yml/badge.svg)](https://github.com/PabloFerrerGonzalez333/gamma/actions/workflows/ci.yml)
